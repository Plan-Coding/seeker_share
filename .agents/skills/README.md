...
> **当前已安装技能:5 个**(`frontend/toolbox-tool`、`frontend/page-conventions`、`backend/api-endpoint`、`meta/issue-workflow`、`meta/commit-release`)。
...
| [page-conventions](frontend/page-conventions/SKILL.md) | frontend | 通用页面/列表规范(分页、搜索、空状态、危险操作确认、反馈等) |
